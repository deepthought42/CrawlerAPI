				...
				.match(PageFoundMessage.class, message-> {
					...
					do {
						...
						try {
							...
							log.warn("building page state with elements");
							PageState page_state = browser_service.buildPageStateWithElements( page, browser);
					...
					}while(!page_state_build_success && error_cnt < 100);
