		...
		return receiveBuilder()
				.match(TestCandidateMessage.class, message-> {
					...
					log.warn("domain url :: "+domain.getUrl());
			  		...
			  		Test test = test_creator_service.createTest(message, final_path_keys, final_path_objects, message.getResultPage(), (end-start), message.getBrowser().toString(), domain_url.getHost());
