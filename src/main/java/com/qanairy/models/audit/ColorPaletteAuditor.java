 ...
 */
@Component
public class ColorPaletteAuditor implements IExecutablePageStateAudit {
	private static Logger log = LoggerFactory.getLogger(ColorPaletteAuditor.class);

	private List<String> gray_colors = new ArrayList<>();
	private List<String> colors = new ArrayList<>();
	
	public ColorPaletteAuditor() {
	...
	public Audit execute(PageState page_state) {
		...
		return new ColorPaletteAudit(AuditCategory.COLOR_MANAGEMENT, buildBestPractices(), getAdaDescription(), getAuditDescription(), AuditSubcategory.COLOR_PALETTE, score, observations, AuditLevel.PAGE, new ArrayList<>(filtered_colors.keySet()), new ArrayList<>(gray_colors.keySet()), color_scheme);
	}
