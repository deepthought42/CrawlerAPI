 ...
 *
 */
public class AccessibilityAudit extends Audit {
	...
	private List<BugMessage> errors;
	...
	public List<BugMessage> getErrors() {
		return errors;
	}

	public void setErrors(List<BugMessage> errors) {
		this.errors = errors;
	}
	
	public void addError(BugMessage error) {
