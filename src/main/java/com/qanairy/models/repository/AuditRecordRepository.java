...
public interface AuditRecordRepository extends Neo4jRepository<AuditRecord, Long> {
	...
	@Query("MATCH (page_audit:PageAuditRecord{key:$page_audit_key})-[]->(audit:Audit) OPTIONAL MATCH y=(audit)-->(:Observation) OPTIONAL MATCH z=(e)-->(f:ElementState) RETURN audit,y,z")
