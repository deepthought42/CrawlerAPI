...
public enum RuleType {
	PATTERN, REQUIRED, ALPHABETIC_RESTRICTION, SPECIAL_CHARACTER_RESTRICTION, NUMERIC_RESTRICTION, DISABLED, NO_VALIDATE, READ_ONLY, MINIMUM_VALUE, MAXIMUM_VALUE, MINIMUM_LENGTH, MAXIMUM_LENGTH, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE, EMAIL_PATTERN;
